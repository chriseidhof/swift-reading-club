// This code follows the paper http://okmij.org/ftp/tagless-final/course/lecture.pdf
// until Swift's compiler started segfaulting (as of Swift4)
...
// this causes Swift compiler to segfault. Why?
func fix<A>(_ f: @escaping (A) -> A) -> () -> A {
	return { () in f(fix(f)()) }
}
